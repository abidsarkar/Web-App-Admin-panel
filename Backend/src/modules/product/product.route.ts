...
import { createProductController, deleteProductController, deleteProductImageController, replaceProductImageController, uploadProductCoverPicController, uploadProductManyPicController } from "./product.controller";
